...
'appadmin is disabled because insecure channel': 'Административная панель заблокирована. Используйте защищенное соединение.',
...
'enter an integer between %(min)g and %(max)g': 'введите целое значение от %(min)g до %(max)g',
'Errors': 'Errors',
